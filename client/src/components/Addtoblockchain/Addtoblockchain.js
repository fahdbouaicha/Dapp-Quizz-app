    ...
    <div className="App">
      <div className="App-header">
        ...
        <div className="description">
          <h1>Certifica.sol</h1>
          <h3>
            Full stack dapp using ReactJS and Hardhat to deploy Certification
            for student in the Blockchain
          </h3>
        </div>
        ...
        <input
          ...
          value={message}
          placeholder="Set Certifica Info"
        />

        {/* Current Value stored on Blockchain */}
        <h2 className="greeting">Certifica: {currentGreeting}</h2>
      </div>
    </div>
  );
}
